            ...
            <Container>
                <div className={styles.container}>
                            ...
                            {genderList?.map(item => (
                                <li key={categories[item].title} className={styles.categoryItem}>
                                    <h3 className={styles.categorySubtitle}>
                                        <NavLink to={`/catalog/${item}`} className={styles.link}>{categories[item].title}</NavLink>
                                    </h3>
                                    <ul className={styles.categorySublist}>
                                        {categories[item]?.list?.map(category => (
                                            <li key={category.slug}>
                                                <NavLink to={`/catalog/${item}/${category.slug}`} className={styles.link}>
                                                    {category.title}
                                                </NavLink>
                                            </li>
                                        ))}
                    ...
                    <div className={styles.social}>
                        <h2 className={classNames(styles.title, styles.socialTitle)}>Связаться с нами</h2>
                        <p className={styles.socialSubtitle}>Контакты и адреса магазинов</p>
                        <ul className={styles.socialList}>
                            <li>
                                <a href="/" className={classNames(styles.link, styles.socialLinkVK)}>
                            ...
                            <li>
                                <a href="/" className={classNames(styles.link, styles.socialLinkFB)}>
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <Social /> */}
                    <Contacts />
                    <div className={styles.copyright}>&copy;INSPIRED, 2023</div>
                    <div className={styles.development}>
                        <ul className={styles.developmentList}>
                            <li className={styles.developmentItem}>Designer: <a href="/" className={styles.link}>Anastasia Ilina</a></li>
                            <li className={styles.developmentItem}>Developer: <a href="/" className={styles.link}>Richi</a></li>
                        </ul>
                    </div>
                </div>
            </Container>
